...
class HydraDemoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HydraHomePage(),
    );
  }
}

class HydraHomePage extends StatefulWidget {
  const HydraHomePage({super.key});

  @override
  State<HydraHomePage> createState() => _HydraHomePageState();
}

class _HydraHomePageState extends State<HydraHomePage> {
            ...
            Expanded(
              child: DecoratedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, i) => SelectableText(_log[i], style: const TextStyle(fontFamily: 'monospace', fontSize: 12)),
                ),
              ),
            ),
          ],
